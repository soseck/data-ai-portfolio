...
const Hero = () => {
  ...
  return (
    <section id="home" className="bg-gradient-to-r from-teal-500 to-blue-600 text-white py-20 md:py-32 min-h-[calc(100vh-4rem)]">
      <div className="container mx-auto px-4 flex flex-col justify-center h-full">
        <div className="flex flex-col md:flex-row items-center mb-8 md:mb-12">
          <div className="w-full md:w-1/2 mb-8 md:mb-0 flex items-center justify-center">
            <img src="/portfolio.jpeg" alt="Ndeye Sokhna SECK" className="w-40 h-40 md:w-64 md:h-64 object-cover shadow-lg rounded-full" />
          </div>
        ...
        <div className="w-full md:w-3/4 mx-auto mt-12 md:mt-16"> {/* Added margin top here */}
          <TechCarousel />
        </div>
      </div>
    </section>
